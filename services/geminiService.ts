...
1.  **Rainfall Data:** Use your internal knowledge to estimate the average annual rainfall and monsoon season (June-Sept) rainfall in millimeters for the given latitude and longitude in India.
2.  **Runoff Calculation:** Calculate the annual harvestable rainwater volume.
    ...
    -   Use these exact Runoff Coefficients:
        ...
        -   thatch (Thatch): 0.6
3.  **System Efficiency:** Apply a 90% (0.90) system efficiency factor to the final calculated volume to account for first flush, evaporation, and other losses. The final reported volume must be this net value.
4.  **Financials:**
...
5.  **Groundwater & Aquifer:**
    -   Use your internal data to estimate the \`Average Depth to Groundwater (meters)\` at the location.
    -   Write a concise \`Aquifer Note\` (2-3 sentences) describing the local hydrogeology and its suitability for artificial recharge.
6.  **Recharge Structure Recommendation:**
...
7.  **Feasibility Score:**
    -   Assign a score ('High', 'Moderate', 'Low') based on a combination of factors: harvestable volume, payback period, and groundwater conditions.
